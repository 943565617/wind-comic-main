 ...
 * 输出 videos/wc-promo/assets/audio/bgm.mp3。Usage: node videos/wc-promo/gen-bgm.mjs
 */
import fs from 'fs';
...
async function main() {
  ...
  const body = {
    model: 'music-2.6',
    prompt: 'cinematic epic orchestral trailer music, dark premium, rising tension, subtle electronic pulse, heroic uplifting finale, instrumental, no vocals',
    lyrics: '##\n[Music]\n##',
